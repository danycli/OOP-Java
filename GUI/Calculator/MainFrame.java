...
public class MainFrame extends JFrame{
    ...
    public MainFrame(){
        ...
        setSize(465,712);
        setTitle("Calculator");
        ImageIcon favicon = new ImageIcon(getClass().getResource("Images/CALCULATOR.png"));
        ...
        text.setBackground(new Color(155, 155, 156));
        ...
        btn1 = ButtonStyling.arithmeticOp("1", 0, 448,new Color(55, 55, 56));
        btn2 = ButtonStyling.arithmeticOp("2", 112, 448,new Color(55, 55, 56));
        btn3 = ButtonStyling.arithmeticOp("3", 224, 448,new Color(55, 55, 56));
        btn4 = ButtonStyling.arithmeticOp("4", 0, 336,new Color(55, 55, 56));
        btn5 = ButtonStyling.arithmeticOp("5", 112, 336,new Color(55, 55, 56));
        btn6 = ButtonStyling.arithmeticOp("6", 224, 336,new Color(55, 55, 56));
        btn7 = ButtonStyling.arithmeticOp("7", 0, 224,new Color(55, 55, 56));
        btn8 = ButtonStyling.arithmeticOp("8", 112, 224,new Color(55, 55, 56));
        btn9 = ButtonStyling.arithmeticOp("9", 224, 224,new Color(55, 55, 56));
        btn0 = ButtonStyling.zero("0", 0, 560);
        add = ButtonStyling.arithmeticOp("+", 336, 112,new Color(241, 154, 17));
        subtract = ButtonStyling.arithmeticOp("-", 336, 224,new Color(241, 154, 17));
        divide = ButtonStyling.arithmeticOp("/", 336, 448,new Color(241, 154, 17));
        multiply = ButtonStyling.arithmeticOp("x", 336, 336,new Color(241, 154, 17));
        AC = ButtonStyling.arithmeticOp("AC", 0, 112,new Color(105, 105, 106));
        decimal = ButtonStyling.arithmeticOp(".", 112, 112,new Color(105, 105, 106));
        clearOne = ButtonStyling.arithmeticOp("", 224, 112,new Color(105, 105, 106));
        ImageIcon clear = new ImageIcon(getClass().getResource("Images/CLEAR.png"));
        clearOne.setIcon(clear);
        equal = ButtonStyling.arithmeticOp("=", 336, 560,new Color(241, 154, 17));
